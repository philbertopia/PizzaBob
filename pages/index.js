  ...
  return (
    <div>
      <section>
        <div className="w-full">
          ...
          <div className="mx-5 rounded-xl overflow-hidden">
            <Image  src="/images/zbob-hero-2.png" alt="" width={500} height={300} />
          </div>
        </div>

      
        <div className='p-5 mx-5 my-10 bg-yellow-50 rounded-xl border-2 border-black'>
          {address ? (
            <>
              <div className="flex flex-col w-full text-center text-4xl font-bold mb-5">
                <h1>BUY</h1>
                <h1 className="mb-3">PIZZABOB</h1>
                <div className="flex justify-center">
                  <Image src="/images/zbob-logo-circle.png" alt="" width={120} height={120}/>
                </div>
              </div>
      ...
      <section>
        ...
        <div className='border-2 border-black rounded-xl p-5 mx-5 my-5 bg-yellow-50'>
          <div className="flex justify-center mb-5">
            <h1 className="text-xl font-semibold">PHASE 1</h1>
          </div>
          <div className="mb-10">
        ...
        <div className='border-2 border-black rounded-xl p-5 mx-5 mb-10 bg-yellow-50'>
          <div className="flex justify-center mb-5">
            <h1 className="text-xl font-semibold">PHASE 3</h1>
          </div>
          <div>
          ...
          <AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4}>
                <div>
                  ...
                  <h1 className="font-bold">1. Download a wallet or exchange</h1>
                  <p>Download a trusted cryptocurrency wallet or exchange that supports the Polygon.</p>
                  <div className="flex justify-around">
                    <Link href="/">Metamask</Link>
                    <Link href="/">Phantom</Link>
                    <Link href="/">Uniswap Wallet</Link>
                ...
                <div>
                  ...
                  <div className="flex justify-center">
                    <Link href="/"><Image src="/images/uniswap-uni-seeklogo.svg" alt="Twitter button" width={100} height={100} /></Link>
                    <Link href="/"><Image src="/images/token-dim.svg" alt="Twitter button" width={100} height={100} /></Link>
                  </div>
                </div>
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4}>
                ...
                <p className="mb-5">Check out Polygon website for more details on Polygon.</p>
                <div className=" w-full flex justify-center gap-8">
                    <Link href="/"><Image src="/images/twitter.png" alt="Twitter button" width={50} height={50} /></Link>
                    <Link href="/"><Image src="/images/telegram.png" alt="Telegram button" width={50} height={50} /></Link>
                </div>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pb={4}>
                ...
                <p className="mb-2">5. <span className="font-semibold">Review and Confirm:</span> Carefully review the swap details (amount of MATIC swapped, estimated PIZZA received, fees) before confirming the transaction.</p>
